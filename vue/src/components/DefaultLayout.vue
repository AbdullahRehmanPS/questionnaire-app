...
<!--                   src="https://tailwindui.com/img/logos/mark.svg?color=indigo&shade=500" alt="Your Company" />-->
          ...
          <div class="-mr-2 flex md:hidden">
            <!-- Mobile menu button -->
            <DisclosureButton class="inline-flex items-center justify-center rounded-md bg-gray-700
            p-2 text-gray-400 hover:bg-gray-500 hover:text-white focus:outline-none focus:ring-2
...
<!--      mobile -->
      <DisclosurePanel class="md:hidden">
        ...
        <div class="border-t border-gray-700 pt-4 pb-3">
          ...
          <div class="mt-3 space-y-1 px-2 bg-gray-200 rounded-3xl">
            <DisclosureButton
              as="a"
              @click="logout"
              class="block
