    ...
    <div class="flex justify-between items-center mt-3">
      ...
      <div class="flex items-center">
        ...
        <button
          ...
          type="button"
          @click="emit('delete', questionnaire)"
          class="h-8 w-8 flex items-center justify-center rounded-full border border-transparent text-sm text-red-500 focus:ring-2 focus:ring-offset-2 focus:ring-red-500 hover:text-red-700"
        >
          <svg xmlns="http://www.w3.org/2000/svg" fill="none"
